window.onload = () => {
  ...
  const inEvent = (e, index) => {
    ...
    persons[index].style.transform = 'scale(1.1)';
  };
      ...
      p.addEventListener('click', () => {
        ...
        if (i < 12 || i > 21) {
          ...
          $(card)
            ...
            .attr(
              'src',
              `assets/images/organization members/person-${num}.png`
            );
          // backgroung.setAttribute(
          //   'src',
          //   `assets/images/organization members/bg-${num}.png`
          // );
  ...
  function hideSectionHandler() {
    closeBtn &&
      closeBtn.addEventListener('click', () => {
        console.log('close');
        topContent.classList.remove('min-h-screen');
        ...
        overlay.style.backgroundImage = `unset`;
