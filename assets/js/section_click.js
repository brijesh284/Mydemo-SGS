...
var mouseover = false;
jQuery(document).ready(function() {
  jQuery('.hex-surround-common').css({'z-index':'100',opacity:0});
  // jQuery('.hex-surround-blank').css('display','none');
  var img1_classes = jQuery('.img1').attr('class').replace('hidden', '').replace('hex-surround-common', 'hex-surround-hover');
  var img2_classes = jQuery('.img2').attr('class').replace('hidden', '').replace('hex-surround-common', 'hex-surround-hover');
  var img3_classes = jQuery('.img3').attr('class').replace('hidden', '').replace('hex-surround-common', 'hex-surround-hover');
  var img4_classes = jQuery('.img4').attr('class').replace('hidden', '').replace('hex-surround-common', 'hex-surround-hover');
  var img5_classes = jQuery('.img5').attr('class').replace('hidden', '').replace('hex-surround-common', 'hex-surround-hover');
  var img6_classes = jQuery('.img6').attr('class').replace('hidden', '').replace('hex-surround-common', 'hex-surround-hover');
    ...
    jQuery('.hex-surround'+value).mouseover(function(){
        if(!mouseover){     
          ...
          setTimeout(function(){
            ...
            jQuery('.hex-surround-hover').css({'transition':'0','opacity':'0'});
